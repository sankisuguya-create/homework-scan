...
var Teacher = (function(){
  ...
  function dayPane(Dx, pane, label){
    ...
    return '<div class="sec" data-pane="' + pane + '"><h2>' + icon("calendar") + label + 'の 宿題（'
      ...
      + '<div class="line"><button class="btn primary" data-t="save-pane" data-pane="' + pane + '">' + icon("save") + label + 'の 宿題を 決める</button>'
  ...
  function onClick(e){
    ...
    if(t === "save-pane") return savePane(b.getAttribute("data-pane"), b);
